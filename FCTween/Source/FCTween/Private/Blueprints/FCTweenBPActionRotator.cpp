...
UFCTweenBPActionRotator* UFCTweenBPActionRotator::TweenRotator(FRotator Start, FRotator End, float DurationSecs, EFCEase EaseType, float EaseParam1, float EaseParam2, float Delay,
...
UFCTweenBPActionRotator* UFCTweenBPActionRotator::TweenRotatorCustomCurve(FRotator Start, FRotator End, float DurationSecs, UCurveFloat* Curve, float Delay, int Loops,
